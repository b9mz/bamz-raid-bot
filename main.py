...
if language == "2":
    ...
    print("\n")
    token = str(input("Insert the bot token here > "))
    message = str(input("Insert the spam message here > "))
    channels_name = str(input("Insert the channels name here > "))
    status = str(input("Insert the bot status here > "))
    prefix = str(input("Insert your bot commands prefix > "))
    ...
    async def on_connect():
        ...
        print("___________________________________________________________________")
        print("\n")
        print(f"The bot status have been set to {status}")
...
if language == "1":
    ...
    status = str(input("Inserez le status ici > "))
    ...
    async def on_connect():
        ...
        print("___________________________________________________________________")
        print("\n")
        print(f"Le status du bot a été définis en {status}")
